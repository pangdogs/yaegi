...
func init() {
	Symbols["os/os"] = map[string]reflect.Value{
		...
		"DevNull":             reflect.ValueOf(constant.MakeFromLiteral("\"NUL\"", token.STRING, 0)),
		...
		"PathListSeparator":   reflect.ValueOf(constant.MakeFromLiteral("59", token.INT, 0)),
		"PathSeparator":       reflect.ValueOf(constant.MakeFromLiteral("92", token.INT, 0)),
